...
public class FileDownloadManager {
    ...
    long startDownload(UpdaterConfig updaterConfig) {
        ...
        req.setDestinationInExternalFilesDir(updaterConfig.getContext(), Environment.DIRECTORY_DOWNLOADS, "mastra.apk");
        //第二种
        //file:///storage/emulated/0/Download/update.apk
        req.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "mastra.apk");
        ////第三种 自定义文件路径
